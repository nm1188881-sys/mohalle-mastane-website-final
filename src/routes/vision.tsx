    ...
    <main className="min-h-dvh bg-background text-foreground">
      ...
      <section className="on-dark concrete-dark light-shaft-dark text-background py-24 md:py-36 border-t border-border">
        <div className="relative z-[1] mx-auto max-w-[900px] px-5 md:px-12 text-center">
          <div className="plate text-accent mb-8">03 — The Long View</div>
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
            ...
            <Link
              to="/events"
              className="inline-flex items-center justify-center px-7 py-3.5 border border-background/30 text-[11px] uppercase tracking-[0.28em] hover:border-accent hover:text-accent transition-colors"
            >
              Volunteer With Us
            </Link>
          </div>
